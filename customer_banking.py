...
def main():
    ...
    savings_interest = float(input("Enter the APR interest rate for the savings account (in %): "))
    ...
    print(f"Savings Account:\n"
          f"Interest Earned: ${savings_interest_earned:,.2f}\n"
          f"Updated Balance: ${updated_savings_balance:,.2f} for {savings_maturity} months")
    # Prompt the user to set the CD balance, interest rate, and months for the CD account.
    # ADD YOUR CODE HERE
    cd_balance = float(input("\nEnter the CD account balance: "))
    cd_interest = float(input("Enter the APR interest rate for the CD account (in %): "))
    ...
    print(f"CD Account:\n"
          ...
          f"Updated Balance: ${updated_cd_balance:,.2f} for {cd_maturity} months")
